...
SHELL_STATIC_SUBCMD_SET_CREATE(device_cmds,
	SHELL_CMD_ARG(pid, NULL,
		      SHELL_HELP("Sets device Product ID",
				"<idProduct>"),
		      cmd_device_pid, 2, 0),
	SHELL_CMD_ARG(vid, NULL,
		      SHELL_HELP("Sets device Vendor ID",
				"<idVendor>"),
		      cmd_device_vid, 2, 0),
	SHELL_CMD_ARG(bcd_usb, &dsub_config_speed,
		      SHELL_HELP("Sets device USB specification version",
				"<speed> <bcdUSB>"),
		      cmd_device_bcd_usb, 3, 0),
	SHELL_CMD_ARG(triple, &dsub_config_speed,
		      SHELL_HELP("Sets device code triple",
				"<speed> <Base Class> <SubClass> <Protocol>)"),
...
SHELL_STATIC_SUBCMD_SET_CREATE(sub_usbd_cmds,
	SHELL_CMD_ARG(defstr, NULL,
		      SHELL_HELP("Adds default string descriptors", NULL),
		      cmd_usbd_default_strings, 1, 0),
	SHELL_CMD_ARG(defcfg, NULL,
		      SHELL_HELP("Initializes default configuration with all available classes",
				NULL),
		      cmd_usbd_default_config, 1, 0),
	SHELL_CMD_ARG(init, NULL,
		      SHELL_HELP("Initializes USB device support", NULL),
		      cmd_usbd_init, 1, 0),
	SHELL_CMD_ARG(enable, NULL,
		      SHELL_HELP("Enables USB device support", NULL),
		      cmd_usbd_enable, 1, 0),
	SHELL_CMD_ARG(disable, NULL,
		      SHELL_HELP("Disables USB device support", NULL),
		      cmd_usbd_disable, 1, 0),
	SHELL_CMD_ARG(shutdown, NULL,
		      SHELL_HELP("Shutdown USB device support", NULL),
		      cmd_usbd_shutdown, 1, 0),
	SHELL_CMD_ARG(select, &dsub_context_name,
		      SHELL_HELP("Selects context used by the shell",
				"<USB device context name>"),
		      cmd_select, 2, 0),
	SHELL_CMD_ARG(device, &device_cmds,
		      SHELL_HELP("Device commands", NULL),
		      NULL, 1, 0),
	SHELL_CMD_ARG(config, &config_cmds,
		      SHELL_HELP("Configuration commands", NULL),
		      NULL, 1, 0),
	SHELL_CMD_ARG(class, &class_cmds,
		      SHELL_HELP("Class commands", NULL),
		      NULL, 1, 0),
	SHELL_CMD_ARG(wakeup, NULL,
		      SHELL_HELP("Signals remote wakeup", NULL),
