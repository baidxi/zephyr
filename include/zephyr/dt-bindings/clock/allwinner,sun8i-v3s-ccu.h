...
#ifndef ZEPHYR_DT_BINDINGS_CLOCK_ALLWINNER_SUN8I_V3S_CCU_H_
#define ZEPHYR_DT_BINDINGS_CLOCK_ALLWINNER_SUN8I_V3S_CCU_H_

/*
 * Clock IDs for Allwinner Sun8i V3s CCU
...
#endif /* ZEPHYR_DT_BINDINGS_CLOCK_ALLWINNER_SUN8I_V3S_CCU_H_ */
